          ...
          <div className="bp-detail">
            ...
            <div className="bp-detail__info-wrap">
              ...
              <span className="bp-detail__h1">
                <a href="blog-detail.html">Wait till its open</a>
              </span>
              ...
              <p className="bp-detail__p">
                Lorem Ipsum is simply dummy text of the <em>printing</em> and
                typesetting industry. Lorem Ipsum has been the industry's
                standard dummy text ever since the 1500s, when an unknown
                <a href="#">printer </a>took a galley of type and scrambled it
              ...
              <p className="bp-detail__p">
                ...
                The point of using <del>Lorem Ipsum</del> is that it has a
              ...
              <blockquote className="bp-detail__q">
                <i className="fas fa-quote-left" />
                <span className="bp-detail__q-title">
                  It’s Easier to Fool People Than to Convince Them That They
                  Have Been Fooled.
                </span>
                <cite className="bp-detail__q-citation">— MARK TWAIN</cite>
              </blockquote>
              <p className="bp-detail__p">
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="d-meta__comment-arena">
                  <span className="d-meta__text u-s-m-b-36">
                        ...
                        <div className="d-meta__p-comment">
                          ...
                          <div className="p-comment__wrap2">
                            ...
                            <span className="p-comment__timestamp">
                              <a href="#">
                                <span>25 March 2015 at 3:55pm</span>
                              </a>
                            </span>
                            <p className="p-comment__paragraph">
                            ...
                            <a className="p-comment__reply" href="#">
                              Reply
                            </a>
                          </div>
                        </div>
                        ...
                        <ol className="comment-children">
                          <li>
                            ...
                            <div className="d-meta__p-comment">
                              <div className="p-comment__wrap1">
                                <div className="aspect aspect--square p-comment__img-wrap">
                                  <img src="images/blog/avatar-2.jpg" alt="" />
                                </div>
                              </div>
                              <div className="p-comment__wrap2">
                                <span className="p-comment__author">Dayle</span>
                            ...
                            <ol className="comment-children">
                              <li>
                                ...
                                <div className="d-meta__p-comment">
                                  ...
                                  <div className="p-comment__wrap2">
                                    <span className="p-comment__author">
                                      Dayle
                                    </span>
                                    <span className="p-comment__timestamp">
                                      <a href="#">
                  ...
                  <span className="d-meta__text-2 u-s-m-b-6">
                    Join the Conversation
                  </span>
                  <span className="d-meta__text-3 u-s-m-b-16">
                  ...
                  <form className="respond__form">
                    <div className="respond__group">
                      <div className="u-s-m-b-15">
                        <label className="gl-label" htmlFor="comment">
                          COMMENT *
                        </label>
                        <textarea
                      ...
                      <div>
                        <p className="u-s-m-b-30">
                          <label className="gl-label" htmlFor="responder-name">
                            NAME *
                          </label>
                          <input
                        ...
                        <p className="u-s-m-b-30">
                          <label className="gl-label" htmlFor="responder-email">
                            EMAIL *
                          </label>
                          <input
                            className="input-text input-text--primary-style"
